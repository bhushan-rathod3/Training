...
function fetchProductDetails(productId) {
    return __awaiter(this, void 0, void 0, function () {
        var product, productDetails, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    productDetails.innerHTML = "\n            <div class=\"card mx-auto p-4\" style=\"max-width: 600px;\">\n                <img src=\"".concat(product.image, "\" class=\"card-img-top p-3\" style=\"height: 400px; object-fit: contain;\">\n                <div class=\"card-body\">\n                    <h2 class=\"card-title\">").concat(product.title, "</h2>\n                    <p class=\"card-text\">").concat(product.description, "</p>\n                    <h4 class=\"text-success\">$").concat(product.price.toFixed(2), "</h4>\n                    <button class=\"btn btn-success\" onclick=\"addToCart(").concat(product.id, ")\">Add to Cart</button>\n                </div>\n            </div>");
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
